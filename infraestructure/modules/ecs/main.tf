...
resource "aws_security_group" "ecs_tasks" {
  name        = "${var.project_name}-${var.environment}-${var.service_name}-ecs-sg"
...
# Additional permissions for ECR and Logs
resource "aws_iam_role_policy" "ecs_task_execution_additional" {
  name = "${var.project_name}-${var.environment}-${var.service_name}-exec-additional"
